"""Over-The-Air (OTA) firmware update system for ESP32-A.

Imported by: main.py
Imports: network, urequests, machine, os, gc, config.wifi_config

Downloads firmware from GitHub (walidaitait/esp32_A/main/test_firmware_a/)
and overwrites local files to perform OTA update.

Trigger mechanisms:
1. Physical button: Hold GPIO16 (UPDATE_BUTTON_PIN) for 5 seconds during boot
