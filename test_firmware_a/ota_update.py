...
def _read_onstart_config():
    ...
    try:
        ...
        # Check if update is requested for ESP32-A
        update_requested = config.get("esp32_a", {}).get("update_requested", False)
        
        if update_requested:
            log("ota", "onstart_config: Update requested for ESP32-A")
        else:
